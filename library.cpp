...
const int PLAYER_INFO_POSX=2000,PLAYER_INFO_LAST_POSX=3640;
const int MAP_POSX=0,MAP_POSY=0,MAP_LAST_POSX=2000,MAP_LAST_POSY=3640;
const int PIXELS_PER_INGAME_UNIT=128;
...
{
 WINDOW=SDL_CreateWindow("Xmax 2107",0,0,RESOLUTION_W,RESOLUTION_H,DISPLAY_MODE);
 SDL_SetWindowPosition(WINDOW,SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED);
 Set_icon("res/images/icon1.png",WINDOW);
